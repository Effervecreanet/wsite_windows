...
#define HTTP_HEADER_UPGRADE_INSECURE "Upgrade-Insecure-Requests"
#define HTTP_HEADER_UPGRADE_INSECURE_VALUE "1"
#define HTTP_HEADER_KEEP_ALIVE "Keep-Alive"

#define HTTP_HEADER_CACHE_CONTROL_VALUE "public, max-age=0"
#define HTTP_HEADER_SERVER_VALUE "wsite/1.1"
...
int nv_find_name_client(struct header_nv nv[HEADER_NV_MAX_SIZE],
                        const char *name_client);
int nv_find_name_wsite(struct header_nv nv[HEADER_NV_MAX_SIZE],
                       const char *name_wsite);
